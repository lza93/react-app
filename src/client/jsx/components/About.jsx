...
React-app is programmed used mostly es6 and some newer syntatic features like async-await on the server. It uses webpack, babel and node-sass to transpile code into regular javascript and css.
